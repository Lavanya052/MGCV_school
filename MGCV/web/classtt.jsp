        ...
        <div id="content-section">
           ...
           <div class="tt">
                ...
                <div style="margin-top: 2vh">
                  ...
                  <%
                for(int i=1;i<9;i++) {
                String qry = "select distinct subcode||'<br>'||teachermail from timetable where cls='" + cls + "' and sec='" + sec + "' and dayorder="+j+" and period = "+ i +" order by period";
              // out.println(qry);
                Vector v = db.getData(stmt, qry, 8, 1);
                   int nr1 = db.getRows(v);
                   int nc1 = db.getCols(v);
                   %>
                   <td> <%
                   for(int x = 1;x<=nr1*nc1;x++)
                   {
                   %>
                  <p style=" font-weight: bold;font-size: 14px;margin-top: 1vh;"><%=v.get(x)%></p>
                   <%
                   }
                    %></td><%
